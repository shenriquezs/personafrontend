...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  displayedColumns: string[] = ['id', 'razonSocial', 'rut', 'fechaInsercion', 'options'];
  ...
  ngOnInit(): void {
    ...
    this.empresaForm = this.fb.group({
      ...
      fechaInsercion: ['', Validators.required],
  ...
  guardarEmpresa(): void {
    this.empresaService.saveEmpresa(this.empresaForm.value).subscribe(resp => {
      this.empresaForm.reset();
      this.empresaForm.setErrors(null);
      this.empresas=this.empresas.filter(empresa=> resp.id!==empresa.id);
